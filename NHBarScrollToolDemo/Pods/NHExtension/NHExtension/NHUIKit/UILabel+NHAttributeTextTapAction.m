//
//  UILabel+NHAttributeTextTapAction.m
//
...
@implementation UILabel (NHAttributeTextTapAction)
                              ...
                              tapClicked:(void (^)(NSString *, NSString *, NSInteger))tapClick
{
    ...
    [self yb_getRangesWithStrings:strings];
    [self yb_getWithHideArray:hideString];
...
- (void)yb_getWithHideArray:(NSArray <NSString *>  *)hideArr{
    if (self.attributedText == nil) {
        return;
    }
